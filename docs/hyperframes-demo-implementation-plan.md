...
<head>
  ...
  <style>
    ...
    * { box-sizing:border-box; }
    ...
    video { display:block; width:100%; height:720px; object-fit:contain; border-radius:18px; background:#090b14; }
...
<body>
  <div id="root" data-composition-id="root" data-width="1920" data-height="1080" data-duration="36" data-fps="30">
    ...
    <section id="s4" class="scene clip" data-start="14" data-duration="9"><div class="content"><div class="evidence-label">Deterministic evidence</div><div class="video-shell"><div class="video-top"><i class="dot"></i><i class="dot"></i><i class="dot"></i></div><video class="clip" src="../evopm-triage.mp4" data-start="14" data-duration="9" data-media-start="3" data-volume="0" muted playsinline></video></div></div></section>
...
- [ ] Load `../evopm-triage.mp4` only in the evidence scene with `data-media-start="3"`, muted playback, and `object-fit: contain`.
